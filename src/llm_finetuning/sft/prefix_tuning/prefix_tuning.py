...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Training and fine-tuning a model using Prefix Tuning"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Number of virtual tokens to use.",
    )
    parser.add_argument(
        "--token_dim", type=int, default=768, help="Dimension of the token embeddings."
    )
    parser.add_argument(
