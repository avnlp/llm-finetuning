...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Training and fine-tuning a model using P-Tuning")
    ...
    parser.add_argument("--num_virtual_tokens", type=int, default=20, help="Number of virtual tokens for P-Tuning.")
    parser.add_argument("--token_dim", type=int, default=768, help="Token dimension for prompt embeddings.")
    parser.add_argument("--num_transformer_submodules", type=int, default=1, help="Number of transformer submodules.")
    parser.add_argument("--num_attention_heads", type=int, default=12, help="Number of attention heads.")
    parser.add_argument("--num_layers", type=int, default=12, help="Number of transformer layers.")
    parser.add_argument(
        "--encoder_reparameterization_type", type=str, default="MLP", help="Reparameterization type for the encoder."
    )
    parser.add_argument("--encoder_hidden_size", type=int, default=768, help="Hidden size of the encoder.")

    # Training arguments
    parser.add_argument("--num_train_epochs", type=int, default=3, help="Number of training epochs.")
    parser.add_argument("--batch_size", type=int, default=1, help="Batch size per device during training.")
    parser.add_argument(
        "--gradient_accumulation_steps", type=int, default=2, help="Number of steps for gradient accumulation."
    )
    parser.add_argument("--learning_rate", type=float, default=2e-4, help="Learning rate for training.")
    parser.add_argument("--push_to_hub", type=bool, default=False, help="Push model to the Hugging Face Hub.")
