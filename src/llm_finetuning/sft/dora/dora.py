"""DoRA fine-tuning module for causal language models."""
...
def main(args) -> None:  # type: ignore[no-untyped-def]
    """Execute DoRA fine-tuning training."""
    ...
    peft_config = LoraConfig(
        ...
        runtime_config=LoraRuntimeConfig(
            ephemeral_gpu_offload=args.dora_ephemeral_gpu_offload
        ),
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Training and fine-tuning a model using LoRA"
    )
    ...
    parser.add_argument(
        "--lora_bias", type=str, default="none", help="Bias configuration for LoRA."
    )
    parser.add_argument(
        "--target_modules",
        type=str,
    ...
    # DoRA arguments
    parser.add_argument(
        "--use_dora", type=bool, default=True, help="Use Dora for training."
    )
    parser.add_argument(
        "--dora_ephemeral_gpu_offload",
        type=bool,
        default=True,
        help="Use CPU offloading for Dora.",
    )
