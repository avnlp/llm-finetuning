"""ARC QLoRA supervised fine-tuning training script.

Fine-tunes a causal language model on the ARC dataset using
...
Dataset:
    HuggingFace ID: allenai/ai2_arc (ARC-Challenge split)
...
def main() -> None:
    """Run the ARC QLoRA fine-tuning pipeline end-to-end.
