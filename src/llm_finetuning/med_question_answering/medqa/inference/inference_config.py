"""Configuration models for MedQA inference pipeline.

This module defines Pydantic models for loading and validating
the YAML configuration file used in the MedQA inference pipeline.
"""
...
class InferenceConfig(BaseModel):
    """Main configuration model for the inference pipeline."""
