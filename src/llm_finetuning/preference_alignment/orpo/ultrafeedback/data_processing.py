"""Dataset loading and formatting for ORPO training on UltraFeedback."""
...
class UltraFeedbackORPOLoader(PreferenceDatasetLoader):
    """Load and format UltraFeedback binarized for ORPO training."""
    ...
    def __init__(
        ...
        """Create an UltraFeedback ORPO loader with optional subsampling."""
        super().__init__(config or self.CONFIG, tokenizer)
        self.fraction = fraction

    def load(self, split: str = "train_prefs") -> Dataset:
        """Load a fraction of the split and map to ORPO `prompt/chosen/rejected`."""
    ...
    def format_example(self, example: dict[str, Any]) -> dict[str, Any]:
        """Map an UltraFeedback row to ORPO columns using `apply_chat_template`."""
