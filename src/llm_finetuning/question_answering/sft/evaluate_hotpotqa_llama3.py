"""Evaluation script for HotPotQA model."""
...
# Configuration
MODEL_PATH = "./unsloth_sft_hotpotqa"  # Path to trained model
...
if __name__ == "__main__":
    ...
    with open(SAMPLE_PREDS_PATH, "w") as f:
        f.write(f"HotpotQA Evaluation Results ({len(test_dataset)} samples)\n")
        f.write("=" * 80 + "\n\n")
